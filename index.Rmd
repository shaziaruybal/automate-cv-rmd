...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://github.com/shaziaruybal/automate-cv-rmd/blob/main/img/social-share-card.png",
    image_alt = paste(
...
--
  ...
  - The materials and slides for this workshop can be found at [github.com/shaziaruybal/automate-cv-rmd](https://github.com/shaziaruybal/automate-cv-rmd) so feel free to come back to them on your own time. This includes the debugging steps that are necessary to get `datadrivencv` to build.
...
- Free Code Camp Talk: Making A Data Driven CV With RMarkdown by Bryan Jenks, watch the video at [youtube.com/watch?v=cMlRAiQUdD8](https://www.youtube.com/watch?v=cMlRAiQUdD8)
